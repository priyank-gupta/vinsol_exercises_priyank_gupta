...
<body id='main'>
	<div>
		<div id='maindiv'>
			<div id='logout'><form method='post' action='home.php'><input type='hidden' name='logout' value='logout'/><input type='image' src='/blog/pictures/logout.jpg' alt='Logout'/></form></div>
